...
var pi_camera_connect_1 = require("pi-camera-connect");
...
var stillCamera = new pi_camera_connect_1.StillCamera();
...
var takePhoto = function () {
    var image = stillCamera.takeImage();
    fs.writeFileSync("request.jpg", image);
};
client.on("ready", function () { return console.log("starting bot"); });
client.on("message", function (msg) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        if (msg.content === "!left") {
            ...
            setTimeout(function () { return board.on("ready", function () {
                //P1-7=gpio4
                this.pinMode("P1-7", 1);
